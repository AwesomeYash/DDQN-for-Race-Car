...
# Include your Wall class and getWalls() function here (copy-paste that part above this)
import pygame
...
def getWalls():
    ...
    # Inner Wall
    wall5 = Wall(200, 100, 800, 100)
    wall6 = Wall(800, 100, 800, 500)
    wall7 = Wall(800, 500, 200, 500)
    wall8 = Wall(200, 500, 200, 100)

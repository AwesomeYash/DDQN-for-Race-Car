...
Description: This file contains the goals for the car racing game.
"""

import pygame

# This class defines the goals for the car racing game.
class Goal:
...
# This function creates the goals for the car racing game.
def getGoals():
    goals = []
